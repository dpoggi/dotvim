...
if has('autocmd')
  ...
  ""
  au FileType apiblueprint,c,cmake,cpp,d,groovy,java,kotlin,lua,objc,objcpp call SpacesLocal(4)
  au FileType openscad,perl,php,python,rust,scala,swift,typescript          call SpacesLocal(4)
