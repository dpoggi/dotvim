...
if has('autocmd')
  ...
  ""
  au FileType apiblueprint,arduino,c,cmake,cpp,d,groovy,java,kotlin,ld,lua,     call SpacesLocal(4)
  au FileType objc,objcpp,openscad,perl,php,python,rust,scala,swift,typescript  call SpacesLocal(4)
